...
export const Controlled: Story = {
  render: () => {
    ...
    return (
      <Collapsible.Root open={open} onOpenChange={setOpen} className="w-full max-w-sm">
        ...
        <div className="mt-2 rounded-md border px-4 py-2 text-sm">@radix-ui/primitives</div>
...
export const Disabled: Story = {
  render: () => (
    <Collapsible.Root disabled className="w-full max-w-sm">
      <Collapsible.Trigger className="w-full">This trigger is disabled</Collapsible.Trigger>
      <Collapsible.Content>
