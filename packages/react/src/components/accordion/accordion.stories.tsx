	...
	render: () => (
		...
		>
			<Accordion.Item value="item-1">
				...
				<Accordion.Content>
					<div className="pb-4 pt-0">This item is expanded by default.</div>
				</Accordion.Content>
			</Accordion.Item>
			<Accordion.Item value="item-2">
			...
			<Accordion.Item value="item-3">
				...
				<Accordion.Content>
					<div className="pb-4 pt-0">Try opening all three items at once.</div>
				</Accordion.Content>
			</Accordion.Item>
		</Accordion.Root>
	),
	...
	render: () => (
		...
		>
			<Accordion.Item value="item-1">
				<Accordion.Trigger>First item</Accordion.Trigger>
				<Accordion.Content>
					<div className="pb-4 pt-0">Content for the first item.</div>
				</Accordion.Content>
			</Accordion.Item>
			<Accordion.Item value="item-2">
	...
	render: () => (
		<Accordion.Root type="single" collapsible className="w-full max-w-md">
			<Accordion.Item value="item-1">
				...
				<Accordion.Content>
					<div className="pb-4 pt-0">This item can be toggled.</div>
				</Accordion.Content>
			</Accordion.Item>
			<Accordion.Item value="item-2" disabled>
				<Accordion.Trigger>Disabled item</Accordion.Trigger>
				<Accordion.Content>
					<div className="pb-4 pt-0">This content is not reachable.</div>
				</Accordion.Content>
			</Accordion.Item>
		</Accordion.Root>
	),
