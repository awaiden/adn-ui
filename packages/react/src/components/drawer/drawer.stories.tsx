      ...
      <Drawer.Content>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <input className="col-span-3 rounded border px-2 py-1" defaultValue="Pedro Duarte" />
          </div>
        </div>
        <Drawer.Footer>
    ...
    <Drawer.Root side="top">
      ...
      <Drawer.Content>
        <Drawer.Header>
          ...
          <Drawer.Description>You have a new message from the system.</Drawer.Description>
        </Drawer.Header>
      </Drawer.Content>
    </Drawer.Root>
  ),
